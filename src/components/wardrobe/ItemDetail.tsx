...
import { Check, Edit3, Wand2, Share2 } from "lucide-react";
    ...
    <div className="bg-white p-6 rounded-2xl border border-stone-200 shadow-sm flex flex-col md:flex-row gap-8">
      ...
      <div className="w-full md:w-1/3">
        <div className="aspect-[3/4] rounded-xl overflow-hidden relative group">
          <img
            src={item.imageUrl || item.imageUrl} // Backend'den gelen alana göre düzenle
        ...
        <div>
          <div className="flex justify-between items-start mb-4">
            <div>
              ...
              <p className="text-sm text-stone-500">Dolabına eklendi.</p>
            </div>
